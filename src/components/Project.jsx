import fishFreshnessImg from '../assets/projects/fish_freshness.jpg';
import agenticHoneypotImg from '../assets/projects/agentic_honeypot.jpg';

const projects = [
  {
    name: 'FishFreshness-Detection-GradCAM',
    title: (
      <>
        FISH FRESHNESS <span className="font-light italic text-gray-300 lowercase font-serif">detection</span><br />
        GRADCAM
      </>
    ),
    description: "An AI-powered fish freshness detection system that analyzes fish images using deep learning and Grad-CAM explainability to accurately classify freshness while providing visual insights into the model's decision-making process.",
    image: fishFreshnessImg,
    github: 'https://github.com/sinhaayushman-102006/FishFreshness-Detection-GradCAM'
  },
  {
    name: 'Agentic Honey-Pot for Scam Detection & Intelligence Extraction',
    title: (
      <>
        AGENTIC HONEY-POT <span className="font-light italic text-gray-300 lowercase font-serif">for</span><br />
        SCAM DETECTION & INTELLIGENCE EXTRACTION
      </>
    ),
    description: "An AI-driven agentic honeypot platform designed for autonomous scam detection, fraudster interaction analysis, and real-time threat intelligence extraction.",
    image: agenticHoneypotImg,
    github: 'https://github.com/sinhaayushman-102006/guvi-honeypot'
  },
  {
    name: 'AI Virtual Mouse using Computer Vision',
    title: (
      <>
        AI VIRTUAL MOUSE <span className="font-light italic text-gray-300 lowercase font-serif">using</span><br />
        COMPUTER VISION
      </>
    ),
    description: "An AI-based Virtual Mouse that allows users to control the mouse cursor using hand gestures captured via a webcam. This project uses computer vision and hand-tracking techniques to replace physical mouse interactions with touch-free gestures.",
    image: "https://images.unsplash.com/photo-1587831990711-23ca6441447b?q=80&w=2000&auto=format&fit=crop",
    github: 'https://github.com/sinhaayushman-102006/AI-Virtual-Mouse'
  },
  {
