...
const servicesData = [
  ...
  },
  {
    ...
    description: 'I build intelligent predictive models, data processing pipelines, and computer vision solutions using industry-standard machine learning frameworks, data science software, and programming languages.',
    capabilities: [
      'Languages: Python, R, SQL',
      'ML/DL Frameworks: PyTorch, TensorFlow, Scikit-Learn',
      'Data Manipulation: Pandas, NumPy, SciPy',
      'Computer Vision & NLP: OpenCV, MediaPipe, Hugging Face',
      'Data Visualization: Matplotlib, Seaborn, Plotly, Tableau',
      'Software & Tools: Jupyter Notebooks, Anaconda, MLflow, Google Colab'
    ]
  },
  {
    id: '06',
